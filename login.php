...
<div class="box login-box">
    <section style="padding: 15px;">
        <div class="login-logo">
            ...
            <div class="panel-title text-center"><span class="logo-lg" style="font-size: 25px;">Atlanexis<b>-BlackDNS</b></span></div>
        </div>
        <!-- /.login-logo -->
        ...
        <div class="card">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-<?php if (!$wrongpassword) { ?>info collapsed-box<?php } else { ?>danger<?php }?>">
                            ...
                            <div class="box-body">
                                <p>After installing Blackdns for the first time, a password is generated and displayed
            ...
            <div class="login-footer" style="margin-top: 15px; display: flex; justify-content: space-between;">
                <a class="btn btn-default btn-sm" role="button" href="https://docs.atlanexis.com/blackdns/" target="_blank"><i class="fas fa-question-circle"></i>BlackDNS Documentation</a>
                <a class="btn btn-default btn-sm" role="button" href="https://release.atlanexis.com/blackdns/latest/" target="_blank"><i class="fab fa-github"></i> BlackDNS Update Releas notes</a>
                <a class="btn btn-default btn-sm" role="button" href="https://atlanexis.com/" target="_blank"><i class="fab fa-discourse"></i> Atlanexis Enterprise</a>
            </div>
        </div>
    </section>
</div>
...
<div class="login-donate">
    <div class="text-center" style="font-size:125%">
        <strong><a href="https://atlanexis.com/donate/" rel="noopener" target="_blank"><i class="fa fa-heart text-red"></i> Donate</a></strong> if you found this useful.
    </div>
</div>
